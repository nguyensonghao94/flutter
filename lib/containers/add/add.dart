...
import 'package:todo/helpers/validate.dart';
import 'package:todo/services/todo.dart';
import 'package:todo/components/button/button.dart';
...
class _AddScreenState extends State<AddScreen> {
  ...
  submit() async {
    if (_loginForm.currentState!.validate()) {
      ...
      try {
        await TodoService.add(_titleCtrl.text, _descriptionCtrl.text, avatar);
        toast(MESSAGE['ADD_TODO_SUCCESS'].toString());
      } catch(e) {
        toast(e.toString());
      }
